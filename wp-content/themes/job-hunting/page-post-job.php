            ...
            <div class="col-12" data-tab>
                ...
                <div class="results-content">
                    <div class="active" data-tab-content="create">
                        <?php
                        get_template_part('template-parts/vacancy/form'); ?>
                    </div>
                    <div data-tab-content="duplicate">
                        <form class="container-fluid p-0 duplicate-job-form" data-author="<?php
                        echo get_current_user_id(); ?>">
                            <div class="row mt-md-4">
                                <div class="col-12 col-xl-3">
                                    <label class="field-label mb-2 mb-md-0 mt-md-3 mt-xl-3"
                                           for="post-job-title-dublicate">Enter a Previous Job ID <span
                                ...
                                <div class="col-12 col-xl-7 mt-md-4 mt-xl-0">
                                    ...
                                    <p class="mt-4"><strong>Important: </strong> Posting an exact copy of an active job
                                        in the same or nearby location will be rejected by the job boards</p>
                                    <button class="btn btn-primary btn-lg mt-4 mt-xl-5" type="submit">Duplicate Job
                                    </button>
                                </div>
                            </div>
                        </form>
