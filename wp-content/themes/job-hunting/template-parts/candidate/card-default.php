    ...
    <div class="results-item <?php echo $isFirst ? 'mt-4' : ''; ?>">
        <div class="container-fluid">
            <div class="row d-flex justify-content-xl-center">
                ...
                <div class="col-12 col-md-6 col-xl-7 d-flex flex-wrap"><small><?php echo nicetime(
                            $post->post_modified
                        ); ?></small>
                    <h4 class="color-primary"><?php echo $candidate->getName(); ?></h4><span
                            class="results-country color-secondary"><?php echo $candidate->getLocation(); ?></span>
                    <ul>
