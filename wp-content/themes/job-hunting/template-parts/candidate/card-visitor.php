 ...
 * @var $args array
 */
$data = $args['visitorData'];
$company = $args['company'];
$isFirst = $args['isFirst'];
$candidate = UserService::getUser($data['visitor']);
...
?>
    <div id="user_<?php echo $candidate->getUserId(); ?>" class="results-item <?php echo $isFirst ? 'mt-4' : ''; ?>">
        <div class="container-fluid">
            <div class="row d-flex justify-content-xl-center">
                ...
                <div class="col-12 col-md-6 col-xl-7 d-flex flex-wrap">
                    ...
                    <ul>
                        <li>
                            <span class="color-secondary">Viewed: <?php echo $vacancy->getTitle(); ?></span>
                        </li>
                        <?php
